...
void AvaliarPopulacao(const std::vector <Individuo>& populacao, const std::vector<double>& x, 
...
void SubsPior(const std::vector <Individuo>& populacao, const Individuo& individuo);
